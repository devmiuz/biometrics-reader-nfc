...
//    SharedPreferences pr  efs = PreferenceManager.getDefaultSharedPreferences(context);
    reverseImage =  false;
  }
  ...
  public synchronized Rect getFramingRect() {
    if (framingRect == null) {
      ...
      int height = screenResolution.y / 5 * 2;
  ...
  public void setTorch(boolean light) {
    configManager.setTorch(camera, light);
  }
}
