...
final class CaptureActivityHandler extends Handler {
  ...
  CaptureActivityHandler(CaptureFragment activity, CameraManager cameraManager, boolean isContinuousModeActive) {
  ...
  public void handleMessage(Message message) {
    if (message.what == R.id.restart_preview) {
      ...
      try {
//        activity.handleOcrContinuousDecode(message.obj);
      ...
      state = State.PREVIEW;
      Toast toast = Toast.makeText(activity.getActivity().getBaseContext(), "OCR failed. Please try again.", Toast.LENGTH_SHORT);
