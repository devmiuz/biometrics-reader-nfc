...
public class MainActivityPassport extends AppCompatActivity {
    ...
    private static final String TAG = MainActivityPassport.class.getSimpleName();
...
//        birthDateView.setText(preferences.getString(KEY_BIRTH_DATE, null));
        ...
        passportNumberView.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                PreferenceManager.getDefaultSharedPreferences(MainActivityPassport.this)
            ...
            try {
                ...
                if (!allFaceImageInfos.isEmpty()) {
                    ...
                    bitmap = ImageUtil.decodeImage(
                            MainActivityPassport.this, faceImageInfo.getMimeType(), inputStream);
        ...
        protected void onPostExecute(Exception result) {
            ...
            if (result == null) {
                ...
                if (getCallingActivity() != null) {
                    ...
                    intent = new Intent(MainActivityPassport.this, ResultActivity.class);
                }
